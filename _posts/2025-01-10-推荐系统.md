...
### Multi-gate  MoE MMoE
![alt text](.\img\recommandsys\RS-MMoe-1.png)
![alt text](.\img\recommandsys\RS-MMoe-2.png)
* 极化现象的出现和解决
...
2. 点击率 * 其他项的加权和
3. 视频平台1
   ![alt text](./img/recommandsys/RS-1.png)
4. 视频平台2 
   ![alt text](./img/recommandsys/RS-2.png)
5. 电商
  ![alt text](./img/recommandsys/RS-3.png)  
### 视频播放建模
* 主要特征
  * 播放时长
